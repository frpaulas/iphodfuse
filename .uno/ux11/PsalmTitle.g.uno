...
public partial class PsalmTitle: iphod.Italic
{
    string _field_Text;
    ...
    void InitializeUX()
    {
        ...
        var temp = new global::iphod.Bold();
        temp_Value_inst = new iphod_FuseControlsTextControl_Value_Property(temp, __selector0);
        var temp2 = new global::Fuse.Reactive.Property(temp1, iphod_accessor_PsalmTitle_Text.Singleton);
        this_Text_inst = new iphod_PsalmTitle_Text_Property(this, __selector1);
        ...
        temp.Margin = float4(-140f, 0f, 0f, 0f);
