...
public partial class TimeOfDeathPage: iphod.Page
{
    ...
    static TimeOfDeathPage()
    {
    }
    [global::Uno.UX.UXConstructor]
    public TimeOfDeathPage(
    ...
    void InitializeUX()
    {
        ...
        temp_eb21 = new global::Fuse.Reactive.EventBinding(temp, __g_nametable);
        var temp4 = new global::iphod.Title();
        temp1.LineNumber = 3;
        temp1.FileName = "Pages/TimeOfDeathPage.ux";
        ...
        temp3.Text = "Back";
        global::Fuse.Gestures.Clicked.AddHandler(temp3, temp_eb21.OnEvent);
        temp3.Bindings.Add(temp_eb21);
        temp4.Value = "Time of Death";
