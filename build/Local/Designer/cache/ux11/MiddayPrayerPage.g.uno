...
public partial class MiddayPrayerPage: iphod.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp19 = new global::Fuse.Gestures.Swiped(swipe);
        ...
        temp18.Children.Add(temp41);
        temp18.Children.Add(temp42);
        temp18.Children.Add(temp43);
        temp18.Children.Add(temp44);
        temp18.Children.Add(temp45);
        temp18.Children.Add(temp46);
        temp18.Children.Add(temp47);
        temp18.Children.Add(temp48);
        temp18.Children.Add(temp49);
        temp18.Children.Add(temp50);
        temp18.Children.Add(temp51);
        temp18.Children.Add(temp52);
        temp18.Children.Add(temp53);
        temp18.Children.Add(temp54);
        temp18.Children.Add(temp55);
        temp18.Children.Add(temp56);
        temp18.Children.Add(temp57);
        temp18.Children.Add(temp58);
        temp18.Children.Add(temp59);
        temp18.Children.Add(temp60);
        temp18.Children.Add(temp61);
        temp18.Children.Add(temp62);
        temp18.Children.Add(temp63);
        temp18.Children.Add(temp64);
        temp18.Children.Add(temp65);
        temp18.Children.Add(temp66);
        temp18.Children.Add(temp67);
        temp18.Children.Add(temp68);
        temp18.Children.Add(temp69);
        temp18.Children.Add(temp70);
        temp18.Children.Add(temp71);
        temp18.Children.Add(temp72);
        temp18.Children.Add(temp73);
        temp18.Children.Add(temp74);
        temp18.Children.Add(temp75);
        temp18.Children.Add(temp76);
        temp18.Children.Add(temp77);
        temp18.Children.Add(temp2);
        temp18.Children.Add(temp3);
        temp18.Children.Add(temp80);
        ...
        temp20.Handler += temp_eb11.OnEvent;
