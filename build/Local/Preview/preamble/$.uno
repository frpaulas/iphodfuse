...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.152"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.2.1"), 12124)}, "/Users/paulsutcliffe/Documents/F/fuse/iphod/iphod.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("iphod");
}
}
}
