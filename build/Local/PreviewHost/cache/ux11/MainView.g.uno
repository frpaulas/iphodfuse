...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        temp19.Templates.Add(calendarPage);
        temp19.Templates.Add(morningPrayerPage);
        temp19.Templates.Add(middayPrayerPage);
        temp19.Templates.Add(eveningPrayerPage);
        temp19.Templates.Add(complinePage);
        temp19.Templates.Add(familyPrayerPage);
        temp19.Templates.Add(reconciliationPage);
        temp19.Templates.Add(toTheSickPage);
        temp19.Templates.Add(communionToSickPage);
        temp19.Templates.Add(timeOfDeathPage);
        temp19.Templates.Add(stationsOfTheCrossPage);
