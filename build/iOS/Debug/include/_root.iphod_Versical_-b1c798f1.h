...
namespace g{struct iphod_Versical_Text_Property;}
...
struct iphod_Versical_Text_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Versical*> _obj;

    void ctor_3(::g::Versical* obj, ::g::Uno::UX::Selector name);
    static iphod_Versical_Text_Property* New1(::g::Versical* obj, ::g::Uno::UX::Selector name);
};
// }
