...
namespace g{struct iphod_accessor_iphod_Button_Text;}
...
struct iphod_accessor_iphod_Button_Text : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return iphod_accessor_iphod_Button_Text_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return iphod_accessor_iphod_Button_Text_typeof()->Init(), Singleton_; }

    void ctor_1();
    static iphod_accessor_iphod_Button_Text* New1();
};
// }
