...
namespace g{struct iphod_accessor_Psalm_StartVs;}
...
struct iphod_accessor_Psalm_StartVs : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return iphod_accessor_Psalm_StartVs_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return iphod_accessor_Psalm_StartVs_typeof()->Init(), Singleton_; }

    void ctor_1();
    static iphod_accessor_Psalm_StartVs* New1();
};
// }
