...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Experimental.Http/1.0.2/$.uno
// -------------------------------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Experimental.Http/1.0.2/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"../../../.....*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"../../../.....*/], 854);
