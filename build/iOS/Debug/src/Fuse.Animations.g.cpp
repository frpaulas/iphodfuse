...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.0.2/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.0.2/$.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Motion shou...*/], this, ::STRINGS[1/*"/Users/paul...*/], 201, ::STRINGS[2/*"set_Motion"*/], NULL);
}
...
static void ContinuousTrackChangeState_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Fuse.Animations/1.0.2/$.uno");
...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[6/*"../../../.....*/], 686);
        return;
    }
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[6/*"../../../.....*/], 1010);
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[6/*"../../../.....*/], 653);
        return;
    }
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Attempt to ...*/], this, ::STRINGS[1/*"/Users/paul...*/], 1636, ::STRINGS[9/*"Register"*/]);
        return;
    }
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[11/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[12/*" cannot be ...*/]), this, ::STRINGS[1/*"/Users/paul...*/], 1793, ::STRINGS[13/*"GiveOriginS...*/]);
    }
}
// }
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[14/*"invalid Mix...*/], 1, ::STRINGS[6/*"../../../.....*/], 1909);
        return;
    }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Resize star...*/], r, ::STRINGS[1/*"/Users/paul...*/], 2754, ::STRINGS[17/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Resize star...*/], r, ::STRINGS[1/*"/Users/paul...*/], 2762, ::STRINGS[17/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[6/*"../../../.....*/], 2903);
        return *__retval = true, void();
    }
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"Invalid seek"*/], 1, ::STRINGS[6/*"../../../.....*/], 3645);
        return;
    }
