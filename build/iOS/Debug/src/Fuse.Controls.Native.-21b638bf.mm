...
static void ImageView_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/1.0.2/ios/$.uno");
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*"MultiDensit...*/], this, ::STRINGS[1/*"/Users/paul...*/], 632, ::STRINGS[2/*"UpdateImage"*/]);
}
