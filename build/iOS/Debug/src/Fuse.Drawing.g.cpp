...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.2/$.uno
// --------------------------------------------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.2/$.uno");
...
{
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"Brush is no...*/], this, ::STRINGS[1/*"/Users/paul...*/], 71, ::STRINGS[2/*"Prepare"*/]);
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.2/$.uno
// ----------------------------------------------------------------------------------------------------
...
static void CoreGraphicsSurface_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.2/$.uno");
...
void CoreGraphicsSurface__DisposePath_fn(CoreGraphicsSurface* __this, ::g::Fuse::Drawing::SurfacePath* path)
{
    ...
    if (cgPath == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"Non CoreGra...*/], path, ::STRINGS[5/*"/Users/paul...*/], 956, ::STRINGS[6/*"DisposePath"*/]);
        return;
    }

    if (::g::Uno::IntPtr::op_Equality(uPtr(cgPath)->Path, ::g::Uno::IntPtr::Zero_))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"Duplicate d...*/], path, ::STRINGS[5/*"/Users/paul...*/], 962, ::STRINGS[6/*"DisposePath"*/]);
        return;
    }
...
void CoreGraphicsSurface__FillPath_fn(CoreGraphicsSurface* __this, ::g::Fuse::Drawing::SurfacePath* path, ::g::Fuse::Drawing::Brush* fill)
{
    ...
    if (cgPath == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"Non CoreGra...*/], path, ::STRINGS[5/*"/Users/paul...*/], 1163, ::STRINGS[8/*"FillPath"*/]);
        return;
    }
...
void CoreGraphicsSurface__Prepare_fn(CoreGraphicsSurface* __this, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"Unsupported...*/], brush, ::STRINGS[5/*"/Users/paul...*/], 1027, ::STRINGS[2/*"Prepare"*/], NULL);
}
...
void CoreGraphicsSurface__PushTransform_fn(CoreGraphicsSurface* __this, ::g::Uno::Float4x4* t)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[15/*"iOS/OSX doe...*/], __this, ::STRINGS[5/*"/Users/paul...*/], 1358, ::STRINGS[16/*"PushTransform"*/]);
...
void CoreGraphicsSurface__StrokePath_fn(CoreGraphicsSurface* __this, ::g::Fuse::Drawing::SurfacePath* path, ::g::Fuse::Drawing::Stroke* stroke)
{
    ...
    if (((uPtr(stroke)->Offset() != 0.0f) || (uPtr(stroke)->Alignment() != 0)) && !CoreGraphicsSurface::_strokeWarning_)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[17/*"iOS/OSX doe...*/], stroke, ::STRINGS[5/*"/Users/paul...*/], 1232, ::STRINGS[18/*"StrokePath"*/]);
    }
    ...
    if (cgPath == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"Non CoreGra...*/], path, ::STRINGS[5/*"/Users/paul...*/], 1238, ::STRINGS[18/*"StrokePath"*/]);
        return;
    }
...
void CoreGraphicsSurface::FillPathImpl(void* path, ::g::Fuse::Drawing::Brush* fill, int fillRule)
{
    ...
    if (linearGradient != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Unprepared ...*/], fill, ::STRINGS[5/*"/Users/paul...*/], 1187, ::STRINGS[10/*"FillPathImpl"*/]);
            return;
        }
    ...
    if (imageFill != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"Unprepared ...*/], fill, ::STRINGS[5/*"/Users/paul...*/], 1202, ::STRINGS[10/*"FillPathImpl"*/]);
            return;
        }
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"Unsupported...*/], fill, ::STRINGS[5/*"/Users/paul...*/], 1219, ::STRINGS[10/*"FillPathImpl"*/], NULL);
}
...
void CoreGraphicsSurface::PrepareLinearGradient(::g::Fuse::Drawing::LinearGradient* lg)
{
    ...
    for (int i = 0; i < stops->Length(); ++i)
    {
        ...
        if ((stop->Offset() > 1.0f) || (stop->Offset() < 0.0f))
            ::g::Fuse::Diagnostics::UserWarning(::STRINGS[13/*"iOS/OSX doe...*/], uBox(::g::Uno::Float_typeof(), uPtr(stop)->Offset()), ::STRINGS[5/*"/Users/paul...*/], 1047, ::STRINGS[14/*"PrepareLine...*/]);
    }
...
void DrawObjectWatcher::Sync()
{
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Sync while ...*/], this, ::STRINGS[5/*"/Users/paul...*/], 2856, ::STRINGS[23/*"Sync"*/]);
        return;
    }
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/drawing/$.uno
// -----------------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.2/brushes/$.uno
// ----------------------------------------------------------------------------------------------------
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    ::g::Fuse::Drawing::ISurfaceDrawable::Draw(uInterface(uPtr(drawable), ::TYPES[25/*Fuse.Drawing.ISurfaceDrawable*/]), this);
    End();
