...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/caching/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/$.uno");
    ...
    ::STRINGS[9] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"/Users/paul...*/], 890, ::STRINGS[13/*"Draw"*/]);
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :1407
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :2578
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[7/*"../../../.....*/], 866);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"/Users/paul...*/], 1052, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"/Users/paul...*/], 1060, ::STRINGS[10/*"Composit"*/]);
    }
}
...
{
    ::STRINGS[14] = uString::Const("element not already inserted anywhere!");
    ::STRINGS[15] = uString::Const("wrong atlas again, dummy!");
    ::STRINGS[16] = uString::Const("Removing from wrong atlas");
...
{
    if (uPtr(elm)->ElementBatchEntry() == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[14/*"element not...*/]));
...
void ElementAtlas::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(entry)->_atlas != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[16/*"Removing fr...*/]));
...
{
    ::STRINGS[17] = uString::Const("Cannot Collect while pinned!");
    ::STRINGS[18] = uString::Const("ElementAtlasFramebuffer already pinned");
    ::STRINGS[19] = uString::Const("ElementAtlasFramebuffer not already pinned");
    ::TYPES[34] = ::g::Uno::EventHandler_typeof();
    type->SetFields(0,
...
void ElementAtlasFramebuffer::Collect()
{
    ...
    if (Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[17/*"Cannot Coll...*/]));
...
{
    ::STRINGS[20] = uString::Const("wrong atlas, stupid!");
    ::STRINGS[21] = uString::Const("element has no caching rect");
    ::STRINGS[22] = uString::Const("wrong batch, stupid!");
...
void ElementBatch::AddElement(::g::Fuse::Elements::Element* elm)
{
    if (uPtr(uPtr(elm)->ElementBatchEntry())->_atlas != _elementAtlas)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[20/*"wrong atlas...*/]));
...
void ElementBatch::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->ElementBatchEntry())->_batch != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[22/*"wrong batch...*/]));
...
::g::Uno::Recti ElementBatch::GetCachingRect(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(bounds)->IsInfinite() || uPtr(bounds)->IsEmpty())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[21/*"element has...*/]));
...
{
    ::STRINGS[23] = uString::Const("Trying to batch nothing!");
    ::STRINGS[24] = uString::Const("BUG: atlas-insertion failed, but should not!");
    ::STRINGS[25] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/caching/$.uno");
...
void ElementBatcher::Draw(::g::Fuse::DrawContext* dc)
{
    ...
    if (uPtr(_elements)->Count() < 1)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[23/*"Trying to b...*/]));
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret27), ret27); enum4.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"BUG: atlas-...*/], 1, ::STRINGS[25/*"../../../.....*/], 1081);
...
{
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[26/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[27/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[28/*"Translation"*/]);
}

static void InteractiveTransform_build(uType* type)
{
    ::STRINGS[26] = uString::Const("ZoomFactor");
    ::STRINGS[27] = uString::Const("Rotation");
    ::STRINGS[28] = uString::Const("Translation");
    type->SetInterfaces(
...
// internal sealed class StandardBoxSizing :363
// {
