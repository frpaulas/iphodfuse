...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Gestures/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Gestures/1.0.2/internal/$.uno
// ------------------------------------------------------------------------------------------------------
...
void Clicker::OnUnrooted()
{
    ...
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _visual, uDelegate::New(::TYPES[7/*Fuse.Input.PointerMovedHandler*/], (void*)Clicker__OnPointerMoved_fn, this));
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/$.uno
// --------------------------------------------------------------------------------------------------------

// private enum Scroller.MoveUserFlags :521
...
{
    Scroller::_horizontalGesture_ = ::g::Fuse::Gestures::SwipeGestureHelper::New1(1.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[12/*Fuse.Gestures.DegreeSpan[]*/], 2, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(45.0f, 135.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-45.0f, -135.0f)));
    Scroller::_verticalGesture_ = ::g::Fuse::Gestures::SwipeGestureHelper::New1(1.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[12/*Fuse.Gestures.DegreeSpan[]*/], 3, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-45.0f, 45.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-135.0f, -180.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(135.0f, 180.0f)));
}
...
static void Scroller_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/$.uno");
...
{
    ::g::Uno::Float2 ret3;
    __this->_significance = (float)((::g::Uno::Vector::Length((::g::Fuse::Motion::Simulation::MotionSimulation::get_Velocity_ex(uInterface(uPtr(__this->_region), ::TYPES[16/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret3), ret3)) > 100.0f) ? 100 : 0);
    return *__retval = 1, void();
}

// private Fuse.Input.GestureRequest Fuse.Input.IGesture.OnPointerReleased(Fuse.Input.PointerReleasedArgs args) :395
void Scroller__FuseInputIGestureOnPointerReleased_fn(Scroller* __this, ::g::Fuse::Input::PointerReleasedArgs* args, int* __retval)
{
    ...
    if (::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(__this->_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
    {
        ...
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(__this->_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__op_UnaryNegation(uPtr(__this->_scrollable)->ConstrainExtents((::g::Fuse::Motion::Simulation::PointerVelocity__get_CurrentVelocity_fn(uPtr(__this->_velocity), &ret4), ret4))));
    }
...
// public void Goto(float2 position) :440
void Scroller__Goto_fn(Scroller* __this, ::g::Uno::Float2* position)
{
    __this->Goto(*position);
}

// private void MoveUser(Fuse.Gestures.Scroller.MoveUserFlags flags, double time) :528
...
// private void OnRequestBringIntoView(object sender, Fuse.RequestBringIntoViewArgs args) :422
...
// private void OnScrollPositionChanged(object s, Fuse.Controls.ScrollPositionChangedArgs args) :501
...
// private void OnUpdated() :469
void Scroller__OnUpdated_fn(Scroller* __this)
{
    __this->OnUpdated();
}

// private void PerformBringIntoView() :430
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector sel) :492
...
// private void UpdateScrollMax() :457
...
// public void CheckLimits() [instance] :413
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[7/*"Scroller.De...*/], this, ::STRINGS[2/*"/Users/paul...*/], 167, ::STRINGS[8/*"set_DelaySt...*/]);
}
...
// public void Goto(float2 position) [instance] :440
...
// private void MoveUser(Fuse.Gestures.Scroller.MoveUserFlags flags, double time) [instance] :528
...
// private void OnRequestBringIntoView(object sender, Fuse.RequestBringIntoViewArgs args) [instance] :422
...
// private void OnScrollPositionChanged(object s, Fuse.Controls.ScrollPositionChangedArgs args) [instance] :501
void Scroller::OnScrollPositionChanged(uObject* s, ::g::Fuse::Controls::ScrollPositionChangedArgs* args)
{
    ...
    if (!uPtr(args)->IsAdjustment())
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::Reset(uInterface(uPtr(_region), ::TYPES[15/*Fuse.Motion.Simulation.BoundedRegion2D*/]), (::g::Uno::UX::ValueChangedArgs__get_Value_fn(uPtr(args), &ret6), ret6));

    CheckNeedUpdated(true);
}

// private void OnUpdated() [instance] :469
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Invalid scr...*/], NULL, ::STRINGS[2/*"/Users/paul...*/], 481, ::STRINGS[3/*"OnUpdated"*/]);
        return;
    }
    ...
    uPtr(_scrollable)->SetScrollPosition1((::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[16/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret7), ret7), (uObject*)this);
    CheckNeedUpdated(true);
}

// private void PerformBringIntoView() [instance] :430
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/paul...*/], 245, ::STRINGS[5/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/paul...*/], 252, ::STRINGS[5/*"UpdatePoint...*/]);
        else
        {
...
// private void UpdateScrollMax() [instance] :457
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Gestures/1.0.2/$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[11/*"Element"*/], __this->Parent(), __this, ::STRINGS[12/*"/Users/paul...*/], 1158, ::STRINGS[13/*"OnRooted"*/]);
        return;
    }
