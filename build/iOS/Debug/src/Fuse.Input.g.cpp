...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/input/$.uno
// ------------------------------------------------------------------------------------------------
...
// public abstract class CustomPointerEventArgs :2028
// {
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual) :2030
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual) [instance] :2030
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/input/$.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"Missing Los...*/], this, ::STRINGS[5/*"/Users/paul...*/], 692, ::STRINGS[6/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
...
// internal static void LoseCapture(int pointIndex) :1492
...
// internal static void LoseCapture(int pointIndex) [static] :1492
...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Capture can...*/], NULL, ::STRINGS[5/*"/Users/paul...*/], 1526, ::STRINGS[15/*"ModifyCapture"*/]);
        return false;
    }
    ...
    if (c != NULL)
    {
        if (uPtr(c)->Visual() != visual)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Cannot modi...*/], identity, ::STRINGS[5/*"/Users/paul...*/], 1537, ::STRINGS[15/*"ModifyCapture"*/]);
    }
    else
    {
...
static void PointerEventArgs_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("localX");
    ::STRINGS[21] = uString::Const("localY");
...
// internal Fuse.Input.PointerEventData get_Data() :1937
...
// private override sealed void Serialize(Fuse.Scripting.IEventSerializer s) :1990
void PointerEventArgs__Serialize_fn(PointerEventArgs* __this, uObject* s)
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[18/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[19/*"index"*/], __this->PointIndex());
    ::g::Uno::Float2 localPoint = uPtr(__this->Visual())->WindowToLocal(__this->WindowPoint());
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[20/*"localX"*/], (double)localPoint.X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[32/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[21/*"localY"*/], (double)localPoint.Y);
}
...
// internal Fuse.Input.PointerEventData get_Data() [instance] :1937
