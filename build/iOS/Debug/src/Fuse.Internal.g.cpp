...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/internal/$.uno
// ----------------------------------------------------------------------------------------------------
...
static void FontFaceDescriptor_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno");
    ...
    ::TYPES[18] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[19] = ::g::Fuse::Resources::FileImageSource_typeof();
    ::TYPES[20] = ::g::Fuse::Resources::HttpImageSource_typeof();
    ::TYPES[21] = ::g::Fuse::Resources::MultiDensityImageSource_typeof();
    ::TYPES[22] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[28/*Uno.Collections.RootableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[24/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, ParamChanged1), 0,
        ::TYPES[24/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceChanged1), 0,
        ::TYPES[25/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceError1), 0);
}
...
void ImageContainer::CreateMultiDensitySource()
{
    ...
    for (uObject* enum4 = (uObject*)uPtr(_files)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[11/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::UX::FileSource* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[15/*Uno.Collections.IEnumerator<Uno.UX.FileSource>*/]), &ret14), ret14);
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    ::g::Fuse::Resources::FileImageSource* f = uAs< ::g::Fuse::Resources::FileImageSource*>(src, ::TYPES[19/*Fuse.Resources.FileImageSource*/]);
    ...
    ::g::Fuse::Resources::MultiDensityImageSource* mf = uAs< ::g::Fuse::Resources::MultiDensityImageSource*>(Source(), ::TYPES[21/*Fuse.Resources.MultiDensityImageSource*/]);

    if (mf != NULL)

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[22/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[11/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Resources::ImageSource* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[23/*Uno.Collections.IEnumerator<Fuse.Resources.ImageSource>*/]), &ret16), ret16);
            ReapplyOptions(s);
        }
}
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[4/*"ResampleMod...*/], this, ::STRINGS[2/*"/Users/paul...*/], 295, ::STRINGS[5/*"set_Resampl...*/]);
...
{
    SourceError1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SourceError1, value), ::TYPES[25/*Fuse.Resources.ImageSourceErrorHandler*/]);
}
...
{
    SourceError1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SourceError1, value), ::TYPES[25/*Fuse.Resources.ImageSourceErrorHandler*/]);
}
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Switching l...*/], this, ::STRINGS[2/*"/Users/paul...*/], 179, ::STRINGS[3/*"UpdateSourc...*/]);
    ...
    if (should)
    {
        uPtr(_source)->add_Changed(uDelegate::New(::TYPES[24/*Uno.EventHandler*/], (void*)ImageContainer__OnSourceChanged_fn, this));
        uPtr(_source)->add_Error(uDelegate::New(::TYPES[25/*Fuse.Resources.ImageSourceErrorHandler*/], (void*)ImageContainer__OnSourceError_fn, this));
    }
    else
    {
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::Collections::List_typeof();
