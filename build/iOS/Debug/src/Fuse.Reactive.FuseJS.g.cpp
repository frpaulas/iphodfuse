...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::setTimeoutf4bcc26c())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::es6promisemin149897e4())->ReadAllText());
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], ::STRINGS[6/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Diagnostics2329f77f()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Observable2cecd502()))->EvaluateExports(context, ::STRINGS[8/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Report requ...*/], this, ::STRINGS[15/*"/Users/paul...*/], 249, ::STRINGS[16/*"Report"*/]);
        return NULL;
    }
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[38/*Fuse.MarshalException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(::STRINGS[50/*"Timer.delet...*/], this, ::STRINGS[15/*"/Users/paul...*/], 829, ::STRINGS[51/*"Delete"*/]);
        }
        else throw __t;
    }
