...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/1.0.2/$.uno
// -------------------------------------------------------------------------------------------------------------
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/1.0.2/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[23/*"(&this).IsO...*/], ::STRINGS[24/*"../../../.....*/], 476, uArray::Init<uObject*>(::TYPES[16/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
