...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno");
...
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"/Users/paul...*/], 477, ::STRINGS[4/*"Root"*/]);
...
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"/Users/paul...*/], 486, ::STRINGS[6/*"Unroot"*/]);
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/$.uno
// -------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno
// --------------------------------------------------------------------------------------------
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 581, ::STRINGS[22/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 735, ::STRINGS[23/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 647, ::STRINGS[31/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 776, ::STRINGS[32/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 820, ::STRINGS[33/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 697, ::STRINGS[24/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/paul...*/], 676, ::STRINGS[25/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/Users/paul...*/], 607, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/Users/paul...*/], 611, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/Users/paul...*/], 615, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Re...*/], this, ::STRINGS[3/*"/Users/paul...*/], 619, ::STRINGS[27/*"ReleaseRoot...*/]);
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno");
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[89/*Uno.UX.Selector*/]))
    {
        *res = uBox(::TYPES[89/*Uno.UX.Selector*/], ::g::Uno::UX::Selector__op_Implicit(::g::Uno::Object::ToString(uPtr(o))));
        return true;
    }
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[56/*"Cannot conv...*/], o), ::STRINGS[57/*"' to target...*/]), t), ::STRINGS[58/*"'"*/]), diagnosticSource, ::STRINGS[59/*"/Users/paul...*/], 654, ::STRINGS[60/*"TryConvertTo"*/], NULL);
...
static void NameRegistry_build(uType* type)
{
    ...
    ::TYPES[68] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::TYPES[66/*Uno.Collections.List<Fuse.INameListener>*/], NULL);
    ::TYPES[69] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetFields(0,
...
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret14), ret14); enum1.MoveNext(::TYPES[68/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[68/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]);
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), &ret24), ret24))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[69/*Uno.Collections.List<Fuse.Node>*/]));
...
{
    Node::_emptyBindings_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[70/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Binding>*/], uArray::New(::TYPES[71/*Fuse.Binding[]*/], 0)));
    Node::_dataListeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[72/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/]));
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[74/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[62/*"_createWatc...*/], uDelegate::New(::TYPES[75/*Uno.Func<Fuse.Scripting.Context, Fuse.Node, object[], object>*/], (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[74/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[63/*"_destroyWat...*/], uDelegate::New(::TYPES[76/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[64/*"findData"*/], 1, ::STRINGS[65/*"function(ke...*/])));
}
...
static void Node_build(uType* type)
{
    ...
    ::TYPES[70] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[71] = ::g::Fuse::Binding_typeof()->Array();
    ::TYPES[72] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL), NULL);
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[73] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[74] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[75] = ::g::Uno::Func3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[78] = Node__DataWatcher_typeof();
    ::TYPES[79] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[80] = ::g::Fuse::Binding_typeof();
    ::TYPES[81] = ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL);
    ::TYPES[9] = ::g::Fuse::IObject_typeof();
    ::TYPES[82] = Node__ISubtreeDataProvider_typeof();
    ::TYPES[83] = Node__IDataEnumerator_typeof();
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[84] = ::g::Uno::Collections::ICollection_typeof()->MakeType(type, NULL);
    ::TYPES[85] = Node__ISiblingDataProvider_typeof();
    ::TYPES[86] = ::g::Uno::Collections::IList_typeof()->MakeType(type, NULL);
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[80/*Fuse.Binding*/], NULL);
    ::TYPES[88] = Node__IDataListener_typeof();
    ::TYPES[89] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[90] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[80/*Fuse.Binding*/], NULL);
    ::TYPES[2] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[80/*Fuse.Binding*/], NULL), offsetof(Node_type, interface0),
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[80/*Fuse.Binding*/], NULL), offsetof(Node_type, interface4),
        ::TYPES[90/*Uno.Collections.IEnumerable<Fuse.Binding>*/], offsetof(Node_type, interface5));
    type->SetFields(1,
        uObject_typeof(), offsetof(::g::Fuse::Node, _bindings), 0,
        ::TYPES[89/*Uno.UX.Selector*/], offsetof(::g::Fuse::Node, _name), 0,
        ...
        ::TYPES[72/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/], (uintptr_t)&::g::Fuse::Node::_dataListeners_, uFieldFlagsStatic,
        ::TYPES[90/*Uno.Collections.IEnumerable<Fuse.Binding>*/], (uintptr_t)&::g::Fuse::Node::_emptyBindings_, uFieldFlagsStatic,
...
void Node__ToString_fn(Node* __this, uString** __retval)
{
    ...
    if (!__this->Name().IsNull())
        return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Object__ToString_fn(__this, &ret12), ret12), ::STRINGS[70/*", Name: "*/]), __this->Name().ToString(::TYPES[89/*Uno.UX.Selector*/])), void();
    else
...
void Node__UnoCollectionsICollectionFuseBindingget_Count_fn(Node* __this, int* __retval)
{
    ...
    if (uIs((uObject*)__this->_bindings, ::TYPES[80/*Fuse.Binding*/]))
...
void Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn(Node* __this, uObject** __retval)
{
    ...
    if (__this->_bindings == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Node::_emptyBindings()), ::TYPES[90/*Uno.Collections.IEnumerable<Fuse.Binding>*/])), void();

    if (uIs((uObject*)__this->_bindings, ::TYPES[80/*Fuse.Binding*/]))
        __this->MakeBindingList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[80/*Fuse.Binding*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->BindingList()), &ret15), ret15)), void();
}
...
void Node::Add(::g::Fuse::Binding* item)
{
    if (_bindings == NULL)
        _bindings = item;
    else if (uIs((uObject*)_bindings, ::TYPES[80/*Fuse.Binding*/]))
...
void Node::AddDataListener(uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[81/*Uno.Collections.List<Fuse.Node.IDataListener>*/]);
...
{
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[80/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :2216
::g::Uno::Collections::List* Node::BindingList()
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[87/*Uno.Collections.List<Fuse.Binding>*/]);
}
...
void Node::EnumerateData(uObject* e)
{
    ...
    while (n != NULL)
    {
        ...
        if (np != NULL)
        {
            uObject* subdp = uAs<uObject*>(np, ::TYPES[82/*Fuse.Node.ISubtreeDataProvider*/]);

            if (subdp != NULL)
            {
                uObject* data = Node__ISubtreeDataProvider::GetData(uInterface(uPtr(subdp), ::TYPES[82/*Fuse.Node.ISubtreeDataProvider*/]), n);

                if ((data != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[83/*Fuse.Node.IDataEnumerator*/]), data))
                    return;
            }
        }
        ...
        if (p != NULL)
            ...
            for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1; i >= 0; i--)
            {
                uObject* sibdp = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[85/*Fuse.Node.ISiblingDataProvider*/]);

                if (sibdp != NULL)
                {
                    uObject* data1 = Node__ISiblingDataProvider::Data(uInterface(uPtr(sibdp), ::TYPES[85/*Fuse.Node.ISiblingDataProvider*/]));

                    if ((data1 != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[83/*Fuse.Node.IDataEnumerator*/]), Node__ISiblingDataProvider::Data(uInterface(sibdp, ::TYPES[85/*Fuse.Node.ISiblingDataProvider*/]))))
                        return;
                }
            }
...
void Node::Insert(int index, ::g::Fuse::Binding* item)
{
    ...
    {
        if (uIs((uObject*)_bindings, ::TYPES[80/*Fuse.Binding*/]))
...
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[87/*Uno.Collections.List<Fuse.Binding>*/]);
    ::g::Fuse::Binding* oldItem = uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[80/*Fuse.Binding*/]);
...
void Node::OnDataChanged(uString* key, uObject* newValue)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Node::_dataListeners()), key, (void**)(&listeners), &ret6), ret6))
        ...
        for (int i = 0; i < uPtr(listeners)->Count(); i++)
            Node__IDataListener::OnDataChanged(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(listeners), uCRef<int>(i), &ret7), ret7)), ::TYPES[88/*Fuse.Node.IDataListener*/]));
}
...
bool Node::Remove(::g::Fuse::Binding* item)
{
    ...
    if ((_bindings == NULL) || uIs((uObject*)_bindings, ::TYPES[80/*Fuse.Binding*/]))
        return false;
...
uObject* Node::_createWatcher(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* callback = uCast< ::g::Fuse::Scripting::Function*>(args->Strong<uObject*>(1), ::TYPES[77/*Fuse.Scripting.Function*/]);
...
{
    Node_typeof()->Init();
    Node__DataWatcher* watcher = uCast<Node__DataWatcher*>(uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[79/*Fuse.Scripting.External*/]))->Object, ::TYPES[78/*Fuse.Node.DataWatcher*/]);
...
static void NodeGroupBase_build(uType* type)
{
    ...
    ::TYPES[91] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[92] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[93] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[94] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Node_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Node_type, interface2),
    ...
    type->SetFields(12,
        ...
        ::TYPES[94/*Uno.Collections.RootableList<Fuse.Node>*/], offsetof(::g::Fuse::NodeGroupBase, _nodes), 0,
...
void NodeGroupBase__OnRooted_fn(NodeGroupBase* __this)
{
    ...
    if (__this->_resources != NULL)
        uPtr(__this->_resources)->Subscribe(uDelegate::New(::TYPES[93/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceAdded_fn, __this), uDelegate::New(::TYPES[93/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceRemoved_fn, __this));
}
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[72/*"AddContent ...*/], this, ::STRINGS[3/*"/Users/paul...*/], 3223, ::STRINGS[73/*"AddContent"*/]);
        return;
    }
    ...
    if (_resources != NULL)
        ...
        for (int i = 0; i < uPtr(_resources)->Count(); i++)
            ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[91/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::RootableList__get_Item_fn(uPtr(_resources), uCRef<int>(i), &ret2), ret2));

    if ((_nodes == NULL) || (uPtr(_nodes)->Count() == 0))
        return;

    int where = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[92/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), this, &ret3), ret3);

    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[74/*"Could not l...*/], this, ::STRINGS[3/*"/Users/paul...*/], 3242, ::STRINGS[73/*"AddContent"*/]);
        return;
    }
...
uObject* NodeGroupBase::Nodes()
{
    if (_nodes == NULL)
    {
        _nodes = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[94/*Uno.Collections.RootableList<Fuse.Node>*/]));
...
{
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[91/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r);
}
...
void NodeGroupBase::OnResourceRemoved(::g::Uno::UX::Resource* r)
{
    ...
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[91/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r, &ret5);
}
...
void NodeGroupBase::RemoveContent()
{
    ...
    if (_resources != NULL)
        ...
        for (int i = 0; i < uPtr(_resources)->Count(); i++)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[91/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::RootableList__get_Item_fn(uPtr(_resources), uCRef<int>(i), &ret7), ret7), &ret6);
...
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[75/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[75] = uString::Const("Parameter");
...
{
    ::TYPES[95] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[96] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[97] = ::g::Fuse::PlacedHandler_typeof();
    type->SetInterfaces(
...
{
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[96/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[95/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[95/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[97/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[96/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
...
{
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[95/*Fuse.IActualPlacement*/])), ::TYPES[95/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[97/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[96/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
...
{
    ::STRINGS[36] = uString::Const("x");
    ::STRINGS[76] = uString::Const("y");
    ::STRINGS[77] = uString::Const("width");
    ::STRINGS[78] = uString::Const("height");
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[36/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[76/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[77/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[78/*"height"*/], (double)NewSize().Y);
}
...
{
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[99] = ::g::Fuse::ITransformMode_typeof();
    type->SetInterfaces(
...
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[99/*Fuse.ITransformMode*/])), ::TYPES[99/*Fuse.ITransformMode*/]), (uObject*)this);
...
void RelativeTransform::ClearSubscription()
{
    ...
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[99/*Fuse.ITransformMode*/])), ::TYPES[99/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}
...
{
    ::TYPES[100] = ::g::Fuse::IFrame_typeof();
    ::TYPES[24] = ::g::Uno::EventHandler_typeof();
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[84] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[86] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[101] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/], offsetof(RootViewport_type, interface6),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(RootViewport_type, interface7),
        ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(RootViewport_type, interface8),
    ...
    type->SetFields(54,
        ::TYPES[100/*Fuse.IFrame*/], offsetof(::g::Fuse::RootViewport, _frame), 0,
        ...
        ::TYPES[101/*Uno.Action<float2>*/], offsetof(::g::Fuse::RootViewport, Resized1), 0);
}
...
void RootViewport__Draw_fn(RootViewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[6/*Fuse.Visual*/]);
        uPtr(v)->Draw(dc);
    }
}
...
void RootViewport__UnoIDisposableDispose_fn(RootViewport* __this)
{
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(__this->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]));
}
...
void RootViewport::ctor_4(uObject* frame)
{
    ...
    ctor_2();
    _frame = frame;
    ::g::Fuse::IFrame::add_FrameChanged(uInterface(uPtr(_frame), ::TYPES[100/*Fuse.IFrame*/]), uDelegate::New(::TYPES[24/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
...
void RootViewport::EstablishSizeInternals()
{
    ...
    _pixelSize = ::g::Fuse::IFrame::Size(uInterface(uPtr(_frame), ::TYPES[100/*Fuse.IFrame*/]));
...
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Resized1, value), ::TYPES[101/*Uno.Action<float2>*/]);
}
...
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Resized1, value), ::TYPES[101/*Uno.Action<float2>*/]);
}
...
{
    ::TYPES[102] = ::g::Fuse::IScalingMode_typeof();
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[102/*Fuse.IScalingMode*/]), this);
}
...
{
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[96/*Fuse.ITransformRelative*/])), ::TYPES[95/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[95/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[97/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[96/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[96/*Fuse.ITransformRelative*/]));
}
...
{
    ::TYPES[103] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[104] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Stage, HasListenersRemoved), 0,
        ::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Listeners), 0,
        ::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Onces), 0,
        ::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, OncesPending), 0,
        ::TYPES[104/*Uno.Collections.List<Fuse.UpdateAction>*/], offsetof(::g::Fuse::Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[103/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    PhaseDeferredActions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[104/*Uno.Collections.List<Fuse.UpdateAction>*/]));
...
{
    ::TYPES[105] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ::TYPES[105/*Uno.Action<Fuse.Transform>*/], offsetof(::g::Fuse::Transform, MatrixChanged1), 0);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[105/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[105/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    ::TYPES[106] = ::g::Fuse::ITranslationMode_typeof();
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[106/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[106/*Fuse.ITranslationMode*/]), __this);
...
::g::Uno::Float3 TranslationModes::SizeOf(::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[95/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[95/*Fuse.IActualPlacement*/]));
}
// }
...
{
    ::TYPES[107] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
        ...
        ::TYPES[107/*Fuse.IUpdateListener*/], offsetof(::g::Fuse::UpdateListener, update), 0);
}
...
void UpdateListener::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[107/*Fuse.IUpdateListener*/]));
}
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[108/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[109/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[109/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[79] = uString::Const("no Action found to remove");
    ::TYPES[108] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof(), NULL);
    ::TYPES[109] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[47] = ::g::Uno::Exception_typeof();
    ::TYPES[110] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[47/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ...
        ::TYPES[109/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[109/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
        ::TYPES[108/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&::g::Fuse::UpdateManager::_stages_, uFieldFlagsStatic,
...
void UpdateManager::ProcessDeferredActions(::g::Fuse::Stage* stage, ::g::Uno::Collections::List** _exceptions)
{
    ...
    for (; stage->PhaseDeferredActionsAt < uPtr(stage->PhaseDeferredActions)->Count(); ++stage->PhaseDeferredActionsAt)
        ...
        catch (const uThrowable& __t)
        {
            ...
            if (*_exceptions == NULL)
                *_exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[110/*Uno.Collections.List<Uno.Exception>*/]);
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[79/*"no Action f...*/]));
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[111/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[80/*"raise"*/], uDelegate::New(::TYPES[112/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[80] = uString::Const("raise");
    ::STRINGS[81] = uString::Const("UserEvent requires a Name");
    ::STRINGS[82] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno");
    ::STRINGS[83] = uString::Const("OnRooted");
    ::STRINGS[84] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[85] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[86] = uString::Const("Trying to Raise on unrooted UserEvent");
    ...
    ::TYPES[113] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[114] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[84] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[86] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[81/*"UserEvent r...*/], __this, ::STRINGS[82/*"/Users/paul...*/], 654, ::STRINGS[83/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[86/*"Trying to R...*/], this, ::STRINGS[82/*"/Users/paul...*/], 701, ::STRINGS[87/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[84/*"Raise must ...*/], n, ::STRINGS[82/*"/Users/paul...*/], 421, ::STRINGS[80/*"raise"*/], NULL);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[113/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[85/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[82/*"/Users/paul...*/], 428, ::STRINGS[80/*"raise"*/], NULL);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[114/*Uno.Collections.Dictionary<string, object>*/]);
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                UserEvent* ue = uAs<UserEvent*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), UserEvent_typeof());
...
{
    ::STRINGS[88] = uString::Const("name");
    ::TYPES[98] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[115] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[116] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[88/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));

    if (__this->Args() != NULL)

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Args()), &ret3), ret3); enum1.MoveNext(::TYPES[115/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > m = enum1.Current(::TYPES[115/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[116/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[116/*Uno.Collections.KeyValuePair<string, object>*/]));
        }
}
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[89/*"IsEnabled"*/]);
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[75/*"Parameter"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[73/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[119/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[75/*"Parameter"*/], uDelegate::New(::TYPES[120/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[90/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[91/*"onParameter...*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[92/*"bringIntoView"*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[89] = uString::Const("IsEnabled");
    ::STRINGS[75] = uString::Const("Parameter");
    ::STRINGS[90] = uString::Const(".notNull().parseJson()");
    ::STRINGS[91] = uString::Const("onParameterChanged");
    ::STRINGS[92] = uString::Const("bringIntoView");
    ::STRINGS[93] = uString::Const("index");
    ::STRINGS[94] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[95] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[73] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[105] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[127/*Fuse.Transform*/], NULL);
    ::TYPES[23] = ::g::Fuse::ICommonViewport_typeof();
    ...
    type->SetInterfaces(
        ...
        ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/], offsetof(Visual_type, interface6),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(Visual_type, interface7),
        ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(Visual_type, interface8),
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret34), ret34);
...
void Visual__OnChildRemoved_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35);
            uObject* obs = uAs<uObject*>(n, ::TYPES[141/*Fuse.IParentObserver*/]);
...
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[91/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
...
void Visual__UnoCollectionsICollectionFuseNodeClear_fn(Visual* __this)
{
    ...
    for (uObject* enum1 = (uObject*)__this->_children.GetEnumerator(::TYPES[137/*Fuse.Internal.MiniList<Fuse.Node>*/]); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[29/*Uno.Collections.IEnumerator*/])); )
    {
...
void Visual__VisitSubtree_fn(Visual* __this, uDelegate* action)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret51), ret51))->VisitSubtree(action);
}
...
{
    Insert1(::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])), item);
}
...
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    ...
    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        ...
        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[11/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[124/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}
...
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret10);
...
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    if (!IsRootingCompleted())
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret11);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret12), ret12))
        return;
...
bool Visual::CalcIsLocalFlat()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret14), ret14), ::TYPES[127/*Fuse.Transform*/]);
...
void Visual::ConcludePendingRemove()
{
    ...
    if (HasBit(268435456))
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]), this, &ret19);
        SetBit1(268435456, false);
    }
}
...
::g::Fuse::Node* Visual::FirstChild(uType* __type)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
    {
        ::g::Fuse::Node* c = uAs< ::g::Fuse::Node*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret23), ret23), __types[0]);
...
void Visual::InsertNodes(int index, uObject* items)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[93/*"index"*/]));
...
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[94/*"Layout was ...*/]));
...
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[24/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[139/*Uno.EventArgs*/]));
}
...
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        uObject* rvl = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret33), ret33), ::TYPES[140/*Fuse.IBeginRemoveVisualListener*/]);
...
void Visual::OnTemplatesChanged(::g::Uno::UX::Template* t)
{
    ...
    if (IsRootingCompleted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            uObject* to = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret38), ret38), ::TYPES[143/*Fuse.ITemplateObserver*/]);
...
{
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[105/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[105/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
void Visual::PrependExplicitTransforms(::g::Fuse::FastMatrix* m)
{
    ...
    if (HasExplicitTransforms())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret40), ret40), ::TYPES[127/*Fuse.Transform*/]);
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[95/*"Invalid cal...*/]));
...
void Visual::RemoveAllChildren(uType* __type)
{
    ...
    ::g::Fuse::Node* ret41;
    int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1;

    while (i >= 0)
    {
        if (uIs((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret41), ret41), __types[0]))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), i);

        i = ::g::Uno::Math::Min8(i, ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/]))) - 1;
    }
}
...
uObject* Visual::Resources()
{
    if (!HasResources())
    {
        ...
        if (IsRootingCompleted())
            uPtr(list)->Subscribe(uDelegate::New(::TYPES[93/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[93/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this));
...
void Visual::UpdateContextSnapToPixelsCache()
{
    ...
    if (newValue != SnapToPixels())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret49), ret49), Visual_typeof());
...
void Visual::UpdateLayout()
{
    ...
    switch (_layoutDirty)
    {
        ...
        case 1:
        {
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret50), ret50), Visual_typeof());
...
void Visual::AssignZOrder(uObject* nodes)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[84/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* visual = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[86/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret9), ret9), Visual_typeof());
...
{
    Visual_typeof()->Init();
    uPtr(v)->AddParameterChangedListener(uCast< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[77/*Fuse.Scripting.Function*/]));
}
// }
...
{
    ::STRINGS[96] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[97] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno");
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[96/*"Invalid Rai...*/], 1, ::STRINGS[97/*"../../../.....*/], 1014);
            return;
        }
    }
...
{
    ::STRINGS[98] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[98/*"visual"*/]));
...
{
    ::STRINGS[99] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[99/*"Wrapped Exc...*/], inner);
}
