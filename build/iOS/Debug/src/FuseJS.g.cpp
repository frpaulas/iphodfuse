...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/FuseJS/1.0.2/$.uno
// --------------------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[55] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/FuseJS/1.0.2/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[54/*"Cannot find...*/], Name), this, ::STRINGS[55/*"/Users/paul...*/], 892, ::STRINGS[56/*"Raise"*/], NULL);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[59/*"The FuseJS/...*/], context, ::STRINGS[55/*"/Users/paul...*/], 923, ::STRINGS[56/*"Raise"*/]);
