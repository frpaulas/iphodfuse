...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/source/uno/graphics/$.uno
// ------------------------------------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/source/uno/graphics/$.uno");
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[2/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[3/*"**** Invali...*/], versionString), 1, ::STRINGS[4/*"../../../.....*/], 975);
            }
            else throw __t;
        }
    }
