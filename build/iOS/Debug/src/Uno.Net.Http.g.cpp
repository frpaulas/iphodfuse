...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.11/$.uno
// ---------------------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.11/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"../../../.....*/], 17);
    else
...
void HttpMessageCache::MaxCacheSizeInBytes(int64_t value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"../../../.....*/], 30);
    else
