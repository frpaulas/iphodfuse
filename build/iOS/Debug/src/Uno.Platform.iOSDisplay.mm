// This file was generated based on '../../../../Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/source/uno/platform/ios/$.uno'.
...
static void iOSDisplay_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../../Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/source/uno/platform/ios/$.uno");
...
void iOSDisplay::ctor_1(::g::ObjC::Object* handle)
{
    ctor_();
    _handle = handle;
    ::g::Uno::Diagnostics::Debug::Assert(_handle != NULL, ::STRINGS[0/*"this._handl...*/], ::STRINGS[1/*"../../../.....*/], 37, uArray::New(::TYPES[0/*object[]*/], 0));
