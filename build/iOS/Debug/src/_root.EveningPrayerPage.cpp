...
#include <_root.EveningPrayerPage.h>
...
// {
// static EveningPrayerPage() :11
static void EveningPrayerPage__cctor_5_fn(uType* __type)
{
    EveningPrayerPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb8"*/]);
}

static void EveningPrayerPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb8");
    ::STRINGS[2] = uString::Const("back");
    ::STRINGS[3] = uString::Const("Pages/EveningPrayerPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Evening Prayer");
    ...
    type->SetFields(106,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::EveningPrayerPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::EveningPrayerPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::EveningPrayerPage, temp_eb8), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::EveningPrayerPage::__g_static_nametable1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Panel_type* EveningPrayerPage_typeof()
{
    ...
    options.ObjectSize = sizeof(EveningPrayerPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("EveningPrayerPage", options);
    type->fp_build_ = EveningPrayerPage_build;
    type->fp_cctor_ = EveningPrayerPage__cctor_5_fn;
...
// public EveningPrayerPage(Fuse.Navigation.Router router) :15
...
// public EveningPrayerPage New(Fuse.Navigation.Router router) :15
void EveningPrayerPage__New6_fn(::g::Fuse::Navigation::Router* router1, EveningPrayerPage** __retval)
{
    *__retval = EveningPrayerPage::New6(router1);
}

uSStrong<uArray*> EveningPrayerPage::__g_static_nametable1_;

// public EveningPrayerPage(Fuse.Navigation.Router router) [instance] :15
void EveningPrayerPage::ctor_9(::g::Fuse::Navigation::Router* router1)
{
    ctor_8();
    router = router1;
    InitializeUX1();
...
void EveningPrayerPage::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, EveningPrayerPage::__g_static_nametable1());
    ...
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/Eveni...*/]);
    ...
    temp4->Value(::STRINGS[5/*"Evening Pra...*/]);
...
// public EveningPrayerPage New(Fuse.Navigation.Router router) [static] :15
EveningPrayerPage* EveningPrayerPage::New6(::g::Fuse::Navigation::Router* router1)
{
    EveningPrayerPage* obj1 = (EveningPrayerPage*)uNew(EveningPrayerPage_typeof());
    obj1->ctor_9(router1);
    return obj1;
}
// }
