...
{
    FamilyPrayerPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb9"*/]);
}
...
static void FamilyPrayerPage_build(uType* type)
{
    ...
    type->SetFields(106,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::FamilyPrayerPage, temp_eb9), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::FamilyPrayerPage::__g_static_nametable1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Panel_type* FamilyPrayerPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("FamilyPrayerPage", options);
