...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"morningPray...*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("morningPrayerPage");
    type->SetFields(2,
...
{
    ::g::MorningPrayerPage* __self1 = ::g::MorningPrayerPage::New6(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"morningPray...*/], false);
    __parent1 = parent;
