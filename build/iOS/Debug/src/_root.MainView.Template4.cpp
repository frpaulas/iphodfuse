...
{
    MainView__Template4::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"eveningPray...*/]);
}

static void MainView__Template4_build(uType* type)
{
    ::STRINGS[0] = uString::Const("eveningPrayerPage");
    type->SetFields(2,
...
{
    ::g::EveningPrayerPage* __self1 = ::g::EveningPrayerPage::New6(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template4::__selector0());
...
{
    ctor_(::STRINGS[0/*"eveningPray...*/], false);
    __parent1 = parent;
