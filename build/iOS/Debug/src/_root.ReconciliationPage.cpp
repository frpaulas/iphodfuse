// This file was generated based on '.uno/ux11/ReconciliationPage.g.uno'.
...
// public partial sealed class ReconciliationPage :2
// {
// static ReconciliationPage() :11
static void ReconciliationPage__cctor_5_fn(uType* __type)
{
    ReconciliationPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb19"*/]);
}

static void ReconciliationPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb19");
    ::STRINGS[2] = uString::Const("back");
    ::STRINGS[3] = uString::Const("Pages/ReconciliationPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Reconciliation");
    ...
    type->SetFields(106,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::ReconciliationPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::ReconciliationPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ReconciliationPage, temp_eb19), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::ReconciliationPage::__g_static_nametable1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Panel_type* ReconciliationPage_typeof()
{
    ...
    options.ObjectSize = sizeof(ReconciliationPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("ReconciliationPage", options);
    type->fp_build_ = ReconciliationPage_build;
    type->fp_cctor_ = ReconciliationPage__cctor_5_fn;
...
// public ReconciliationPage(Fuse.Navigation.Router router) :15
void ReconciliationPage__ctor_9_fn(ReconciliationPage* __this, ::g::Fuse::Navigation::Router* router1)
{
    __this->ctor_9(router1);
}

// private void InitializeUX() :21
void ReconciliationPage__InitializeUX1_fn(ReconciliationPage* __this)
{
    __this->InitializeUX1();
}

// public ReconciliationPage New(Fuse.Navigation.Router router) :15
void ReconciliationPage__New6_fn(::g::Fuse::Navigation::Router* router1, ReconciliationPage** __retval)
{
    *__retval = ReconciliationPage::New6(router1);
}

uSStrong<uArray*> ReconciliationPage::__g_static_nametable1_;

// public ReconciliationPage(Fuse.Navigation.Router router) [instance] :15
void ReconciliationPage::ctor_9(::g::Fuse::Navigation::Router* router1)
{
    ctor_8();
    router = router1;
    InitializeUX1();
...
void ReconciliationPage::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, ReconciliationPage::__g_static_nametable1());
    ...
    temp_eb19 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/Recon...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb19)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb19);
    temp4->Value(::STRINGS[5/*"Reconciliat...*/]);
...
// public ReconciliationPage New(Fuse.Navigation.Router router) [static] :15
ReconciliationPage* ReconciliationPage::New6(::g::Fuse::Navigation::Router* router1)
{
    ReconciliationPage* obj1 = (ReconciliationPage*)uNew(ReconciliationPage_typeof());
    obj1->ctor_9(router1);
    return obj1;
}
// }
