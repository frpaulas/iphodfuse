// This file was generated based on '.uno/ux11/Rubric.g.uno'.
...
// public partial class Rubric :2
// {
// static Rubric() :4
static void Rubric__cctor_6_fn(uType* __type)
{
}
...
::g::Fuse::Controls::TextControl_type* Rubric_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Rubric", options);
    type->fp_build_ = Rubric_build;
    type->fp_ctor_ = (void*)Rubric__New6_fn;
    type->fp_cctor_ = Rubric__cctor_6_fn;
...
// public Rubric() :8
void Rubric__ctor_10_fn(Rubric* __this)
{
    __this->ctor_10();
}

// private void InitializeUX() :12
void Rubric__InitializeUX3_fn(Rubric* __this)
{
    __this->InitializeUX3();
}

// public Rubric New() :8
void Rubric__New6_fn(Rubric** __retval)
{
    *__retval = Rubric::New6();
}

// public Rubric() [instance] :8
void Rubric::ctor_10()
{
    ctor_9();
    InitializeUX3();
