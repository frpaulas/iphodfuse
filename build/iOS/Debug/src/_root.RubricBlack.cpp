// This file was generated based on '.uno/ux11/RubricBlack.g.uno'.
...
// {
// static RubricBlack() :4
static void RubricBlack__cctor_7_fn(uType* __type)
{
}

static void RubricBlack_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* RubricBlack_typeof()
{
    ...
    options.BaseDefinition = ::g::Rubric_typeof();
    options.FieldCount = 100;
    options.InterfaceCount = 16;
    options.ObjectSize = sizeof(RubricBlack);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("RubricBlack", options);
    type->fp_build_ = RubricBlack_build;
    type->fp_ctor_ = (void*)RubricBlack__New7_fn;
    type->fp_cctor_ = RubricBlack__cctor_7_fn;
...
{
    __this->InitializeUX4();
}

// public RubricBlack New() :8
void RubricBlack__New7_fn(RubricBlack** __retval)
{
    *__retval = RubricBlack::New7();
}

// public RubricBlack() [instance] :8
void RubricBlack::ctor_11()
{
    ctor_10();
    InitializeUX4();
}
...
void RubricBlack::InitializeUX4()
{
    Color(::g::Fuse::Drawing::Colors::Black());
    Margin(::g::Uno::Float4__New2(5.0f, 10.0f, 5.0f, 10.0f));
}

// public RubricBlack New() [static] :8
RubricBlack* RubricBlack::New7()
{
    RubricBlack* obj1 = (RubricBlack*)uNew(RubricBlack_typeof());
    obj1->ctor_11();
    return obj1;
}
// }
