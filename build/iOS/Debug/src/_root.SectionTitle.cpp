// This file was generated based on '.uno/ux11/SectionTitle.g.uno'.
...
// public partial sealed class SectionTitle :2
// {
// static SectionTitle() :4
static void SectionTitle__cctor_4_fn(uType* __type)
{
}

static void SectionTitle_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* SectionTitle_typeof()
{
    ...
    options.ObjectSize = sizeof(SectionTitle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("SectionTitle", options);
    type->fp_build_ = SectionTitle_build;
    type->fp_ctor_ = (void*)SectionTitle__New4_fn;
    type->fp_cctor_ = SectionTitle__cctor_4_fn;
...
// public SectionTitle() :8
void SectionTitle__ctor_8_fn(SectionTitle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void SectionTitle__InitializeUX1_fn(SectionTitle* __this)
{
    __this->InitializeUX1();
}

// public SectionTitle New() :8
void SectionTitle__New4_fn(SectionTitle** __retval)
{
    *__retval = SectionTitle::New4();
}

// public SectionTitle() [instance] :8
void SectionTitle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void SectionTitle::InitializeUX1()
{
    FontSize(16.0f);
    Color(::g::Fuse::Drawing::Colors::Black());
    Font(::g::MainView::BoldFont());
}

// public SectionTitle New() [static] :8
SectionTitle* SectionTitle::New4()
{
    SectionTitle* obj1 = (SectionTitle*)uNew(SectionTitle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
