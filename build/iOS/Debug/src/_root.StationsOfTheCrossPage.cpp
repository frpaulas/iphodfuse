...
{
    StationsOfTheCrossPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb20"*/]);
}

static void StationsOfTheCrossPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb20");
    ...
    type->SetFields(106,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::StationsOfTheCrossPage, temp_eb20), 0,
...
::g::Fuse::Controls::Panel_type* StationsOfTheCrossPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("StationsOfTheCrossPage", options);
...
void StationsOfTheCrossPage::InitializeUX1()
{
    ...
    temp_eb20 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb20)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb20);
