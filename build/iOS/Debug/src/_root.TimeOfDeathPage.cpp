...
// {
// static TimeOfDeathPage() :11
static void TimeOfDeathPage__cctor_5_fn(uType* __type)
{
    TimeOfDeathPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb21"*/]);
}

static void TimeOfDeathPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb21");
    ::STRINGS[2] = uString::Const("back");
    ::STRINGS[3] = uString::Const("Pages/TimeOfDeathPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Time of Death");
    ...
    type->SetFields(106,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::TimeOfDeathPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::TimeOfDeathPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::TimeOfDeathPage, temp_eb21), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::TimeOfDeathPage::__g_static_nametable1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Panel_type* TimeOfDeathPage_typeof()
{
    ...
    options.ObjectSize = sizeof(TimeOfDeathPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("TimeOfDeathPage", options);
    type->fp_build_ = TimeOfDeathPage_build;
    type->fp_cctor_ = TimeOfDeathPage__cctor_5_fn;
...
// public TimeOfDeathPage(Fuse.Navigation.Router router) :15
...
// public TimeOfDeathPage New(Fuse.Navigation.Router router) :15
void TimeOfDeathPage__New6_fn(::g::Fuse::Navigation::Router* router1, TimeOfDeathPage** __retval)
{
    *__retval = TimeOfDeathPage::New6(router1);
}

uSStrong<uArray*> TimeOfDeathPage::__g_static_nametable1_;

// public TimeOfDeathPage(Fuse.Navigation.Router router) [instance] :15
void TimeOfDeathPage::ctor_9(::g::Fuse::Navigation::Router* router1)
{
    ctor_8();
    router = router1;
    InitializeUX1();
...
void TimeOfDeathPage::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, TimeOfDeathPage::__g_static_nametable1());
    ...
    temp_eb21 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/TimeO...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb21)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb21);
    temp4->Value(::STRINGS[5/*"Time of Death"*/]);
...
// public TimeOfDeathPage New(Fuse.Navigation.Router router) [static] :15
TimeOfDeathPage* TimeOfDeathPage::New6(::g::Fuse::Navigation::Router* router1)
{
    TimeOfDeathPage* obj1 = (TimeOfDeathPage*)uNew(TimeOfDeathPage_typeof());
    obj1->ctor_9(router1);
    return obj1;
}
// }
