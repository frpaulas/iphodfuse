...
// {
// static ToTheSickPage() :11
static void ToTheSickPage__cctor_5_fn(uType* __type)
{
    ToTheSickPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb22"*/]);
}

static void ToTheSickPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb22");
    ::STRINGS[2] = uString::Const("back");
    ::STRINGS[3] = uString::Const("Pages/ToTheSickPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("To The Sick");
    ...
    type->SetFields(106,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::ToTheSickPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::ToTheSickPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ToTheSickPage, temp_eb22), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::ToTheSickPage::__g_static_nametable1_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* ToTheSickPage_typeof()
{
    ...
    options.ObjectSize = sizeof(ToTheSickPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("ToTheSickPage", options);
    type->fp_build_ = ToTheSickPage_build;
    type->fp_cctor_ = ToTheSickPage__cctor_5_fn;
...
// public ToTheSickPage(Fuse.Navigation.Router router) :15
...
// public ToTheSickPage New(Fuse.Navigation.Router router) :15
void ToTheSickPage__New6_fn(::g::Fuse::Navigation::Router* router1, ToTheSickPage** __retval)
{
    *__retval = ToTheSickPage::New6(router1);
}

uSStrong<uArray*> ToTheSickPage::__g_static_nametable1_;

// public ToTheSickPage(Fuse.Navigation.Router router) [instance] :15
void ToTheSickPage::ctor_9(::g::Fuse::Navigation::Router* router1)
{
    ctor_8();
    router = router1;
    InitializeUX1();
...
void ToTheSickPage::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, ToTheSickPage::__g_static_nametable1());
    ...
    temp_eb22 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/ToThe...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb22)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb22);
    temp4->Value(::STRINGS[5/*"To The Sick"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[4/*Uno.Collections.ICollection<object>*/]), temp_eb22);
...
// public ToTheSickPage New(Fuse.Navigation.Router router) [static] :15
ToTheSickPage* ToTheSickPage::New6(::g::Fuse::Navigation::Router* router1)
{
    ToTheSickPage* obj1 = (ToTheSickPage*)uNew(ToTheSickPage_typeof());
    obj1->ctor_9(router1);
    return obj1;
}
// }
