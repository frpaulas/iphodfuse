// This file was generated based on '.uno/ux11/iphod.Regular.g.uno'.
...
// public partial class Regular :4
// {
// static Regular() :6
static void Regular__cctor_5_fn(uType* __type)
{
}

static void Regular_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Regular_typeof()
{
    ...
    options.ObjectSize = sizeof(Regular);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("iphod.Regular", options);
    type->fp_build_ = Regular_build;
    type->fp_ctor_ = (void*)Regular__New5_fn;
    type->fp_cctor_ = Regular__cctor_5_fn;
...
// public Regular() :10
void Regular__ctor_9_fn(Regular* __this)
{
    __this->ctor_9();
}

// private void InitializeUX() :14
void Regular__InitializeUX2_fn(Regular* __this)
{
    __this->InitializeUX2();
}

// public Regular New() :10
void Regular__New5_fn(Regular** __retval)
{
    *__retval = Regular::New5();
}

// public Regular() [instance] :10
void Regular::ctor_9()
{
    ctor_8();
    InitializeUX2();
...
void Regular::InitializeUX2()
{
    TextWrapping(1);
    Font(::g::MainView::RegularFont());
}

// public Regular New() [static] :10
Regular* Regular::New5()
{
    Regular* obj1 = (Regular*)uNew(Regular_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
