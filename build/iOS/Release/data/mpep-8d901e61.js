...
function getDailyReading(season, week, day ) {
  return mpep[season][week][day];
}

function getDailyTitle(season, week, day) {
  return mpep[season][week][day].title;
}

function getDailyColor(season, week, day) {
  return mpep[season][week][day].color;
}

function getDailyAntiphon(season) {
  return oneOf(mpep.antiphon[season]);
}

function  getDailyOpeningSentence(office, season) {
  return oneOf( mpep[office + "_opening"][season] );
}
