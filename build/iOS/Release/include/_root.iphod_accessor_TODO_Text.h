...
namespace g{struct iphod_accessor_TODO_Text;}

namespace g{

// internal sealed class iphod_accessor_TODO_Text :61
// {
...
struct iphod_accessor_TODO_Text : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return iphod_accessor_TODO_Text_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return iphod_accessor_TODO_Text_typeof()->Init(), Singleton_; }

    void ctor_1();
    static iphod_accessor_TODO_Text* New1();
};
// }
