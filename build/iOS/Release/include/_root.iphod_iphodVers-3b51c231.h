...
namespace g{struct iphod_iphodVersical_Speaker_Property;}
...
struct iphod_iphodVersical_Speaker_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::iphod::Versical*> _obj;

    void ctor_3(::g::iphod::Versical* obj, ::g::Uno::UX::Selector name);
    static iphod_iphodVersical_Speaker_Property* New1(::g::iphod::Versical* obj, ::g::Uno::UX::Selector name);
};
// }
