...
static void ImageView_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.47.7/ios/$.uno");
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*"MultiDensit...*/], this, ::STRINGS[1/*"/Users/paul...*/], 628, ::STRINGS[2/*"UpdateImage"*/]);
}
