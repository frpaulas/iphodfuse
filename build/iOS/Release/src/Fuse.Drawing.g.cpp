...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/0.47.7/$.uno
// ---------------------------------------------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/0.47.7/$.uno");
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/drawing/$.uno
// ------------------------------------------------------------------------------------------------------
...
{
    DynamicBrush::_opacityName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Opacity"*/]);
}
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Drawing/0.47.7/brushes/$.uno
// -----------------------------------------------------------------------------------------------------
...
{
    GradientStop::_offsetName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Offset"*/]);
    GradientStop::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
}

static void GradientStop_build(uType* type)
{
    ::STRINGS[4] = uString::Const("Offset");
...
{
    ImageFill::_sourceName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"Source"*/]);
    ImageFill::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
    ImageFill::_wrapModeName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[7/*"WrapMode"*/]);
    ImageFill::_paramName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[8/*"Param"*/]);
    ImageFill::_sizingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[9/*"Sizing"*/]);
}

static void ImageFill_build(uType* type)
{
    ::STRINGS[6] = uString::Const("Source");
    ::STRINGS[5] = uString::Const("Color");
    ::STRINGS[7] = uString::Const("WrapMode");
    ::STRINGS[8] = uString::Const("Param");
    ::STRINGS[9] = uString::Const("Sizing");
    type->SetInterfaces(
...
{
    LinearGradient::_stopsName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"Stops"*/]);
    LinearGradient::_stopOffsetName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Offset"*/]);
    LinearGradient::_stopColorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
    LinearGradient::_interpolationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[11/*"Interpolation"*/]);
...
{
    ::STRINGS[10] = uString::Const("Stops");
    ::STRINGS[4] = uString::Const("Offset");
    ::STRINGS[5] = uString::Const("Color");
    ::STRINGS[11] = uString::Const("Interpolation");
...
{
    SolidColor::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
}
...
static void Stroke__cctor__fn(uType* __type)
{
    ...
    Stroke::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
    Stroke::_widthName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[17/*"Width"*/]);
    Stroke::_offsetName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Offset"*/]);
