...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/$.uno
// ----------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/caching/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Draw called...*/], __this, ::STRINGS[6/*"/Users/paul...*/], 876, ::STRINGS[10/*"Draw"*/]);
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :1393
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :2562
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[5/*"This elemen...*/], this, ::STRINGS[6/*"/Users/paul...*/], 1038, ::STRINGS[7/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[6/*"/Users/paul...*/], 1046, ::STRINGS[7/*"Composit"*/]);
    }
}
