...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Common/0.47.7/$.uno");
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"/Users/paul...*/], 1884, ::STRINGS[3/*"Run"*/]);
