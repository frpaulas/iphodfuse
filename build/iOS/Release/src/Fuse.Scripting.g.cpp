...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno
// -----------------------------------------------------------------------------------------------
...
{
    ::STRINGS[23] = uString::Const("removeAllListeners");
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[23/*"removeAllLi...*/], uArray::New(::TYPES[9/*object[]*/], 0));
    ::g::Uno::Threading::Monitor::Enter(_mutex);
...
{
    uPtr(o)->CallMethod(::STRINGS[25/*"on"*/], uArray::Init<uObject*>(::TYPES[9/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
{
    ::STRINGS[26] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[27] = uString::Const(" provided");
    ::STRINGS[28] = uString::Const("require(): argument must be a string");
    ::STRINGS[29] = uString::Const("require(): module not found: ");
    ::STRINGS[30] = uString::Const("JavaScript error in ");
    ::STRINGS[31] = uString::Const(" was fixed!");
    ::STRINGS[32] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
    ::STRINGS[33] = uString::Const("Require");
    ::STRINGS[34] = uString::Const(" line ");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[26/*"require(): ...*/], uBox<int>(::TYPES[45/*int*/], uPtr(args)->Length())), ::STRINGS[27/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[50/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[28/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[29/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[30/*"JavaScript ...*/], path), ::STRINGS[31/*" was fixed!"*/]), this, ::STRINGS[32/*"/Users/paul...*/], 1854, ::STRINGS[33/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[30/*"JavaScript ...*/], path), ::STRINGS[34/*" line "*/]), uBox<int>(::TYPES[45/*int*/], uPtr(e)->LineNumber())), ::STRINGS[35/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[32/*"/Users/paul...*/], 1864, ::STRINGS[33/*"Require"*/], NULL);
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[37] = uString::Const("Error message: ");
    ::STRINGS[38] = uString::Const("File name: ");
    ::STRINGS[39] = uString::Const("Line number: ");
    ::STRINGS[40] = uString::Const("Source line: ");
    ::STRINGS[41] = uString::Const("JS stack trace: ");
    ::TYPES[45] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[40/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[41/*"JS stack tr...*/]);
...
{
    ::STRINGS[42] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[32] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
    ::STRINGS[43] = uString::Const("Call");
    ::TYPES[3] = ::g::Uno::Action_typeof();
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[42/*"Cannot call...*/], __this, ::STRINGS[32/*"/Users/paul...*/], 1582, ::STRINGS[43/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[44/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[44] = uString::Const("require(): module contains an error: ");
    ::STRINGS[45] = uString::Const(".js");
    ::STRINGS[9] = uString::Const("");
    ::STRINGS[46] = uString::Const(".");
    ::STRINGS[47] = uString::Const("/");
    ::STRINGS[48] = uString::Const("..");
    ::STRINGS[49] = uString::Const("(function(");
    ::STRINGS[50] = uString::Const(") { ");
    ::STRINGS[51] = uString::Const("\n"
        " })");
    ::STRINGS[52] = uString::Const("Could not evaluate module '");
    ::STRINGS[53] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[19] = uString::Const("exports");
    ::STRINGS[54] = uString::Const("module, exports, require");
    ::STRINGS[55] = uString::Const("/index.js");
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[49/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[50/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[51/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[52/*"Could not e...*/], __this->FileName()), ::STRINGS[53/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[54/*"module, exp...*/], void();
}
...
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[45/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[45/*".js"*/], ::STRINGS[9/*""*/]);

    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[46/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[47/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[9/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[46/*"."*/]))
            continue;
            ...
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[47/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[45/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[55/*"/index.js"*/])))
        return true;
...
{
    ::STRINGS[56] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetPrecalc(
        type->T(0));
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[56/*"ScriptPrope...*/]));
