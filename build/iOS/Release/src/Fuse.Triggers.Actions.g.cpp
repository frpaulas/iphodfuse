...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/triggers/actions/$.uno
// ---------------------------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls/0.47.7/triggers/$.uno
// -------------------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.47.7/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.47.7/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[2/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[3/*"/Users/paul...*/], 240, ::STRINGS[4/*"Perform"*/], NULL);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.47.7/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Requires a ...*/], __this, ::STRINGS[6/*"/Users/paul...*/], 283, ::STRINGS[4/*"Perform"*/], NULL);
        return;
    }
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.47.7/actions/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"`TimelineAc...*/], __this, ::STRINGS[8/*"/Users/paul...*/], 827, ::STRINGS[4/*"Perform"*/], NULL);
        return;
    }
