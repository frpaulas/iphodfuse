...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.47.7/$.uno
// ----------------------------------------------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.47.7/$.uno");
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.47.7/triggers/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.47.7/actions/$.uno
// ------------------------------------------------------------------------------------------------------
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/triggers/$.uno
// -------------------------------------------------------------------------------------------------------
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/paul...*/], 1729, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/paul...*/], 1742, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.47.7/triggers/$.uno");
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"reset takes...*/], s, ::STRINGS[22/*"/Users/paul...*/], 242, ::STRINGS[20/*"check"*/], NULL);
        return;
    }
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/paul...*/], 2148, ::STRINGS[27/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/paul...*/], 1812, ::STRINGS[30/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[31/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/paul...*/], 1792, ::STRINGS[32/*"gotoName"*/], NULL);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/paul...*/], 2569, ::STRINGS[39/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/paul...*/], 2618, ::STRINGS[41/*"seek"*/], NULL);
        return;
    }
...
// /Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.47.7/$.uno
// ---------------------------------------------------------------------------------------------------------
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/Users/paulsutcliffe/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.47.7/$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Transition ...*/], t, ::STRINGS[45/*"/Users/paul...*/], 2709, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Transition ...*/], t, ::STRINGS[45/*"/Users/paul...*/], 2716, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/paul...*/], 2911, ::STRINGS[49/*"Fuse.Animat...*/]);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[51/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/paul...*/], 4274, ::STRINGS[52/*"Pulse"*/]);
