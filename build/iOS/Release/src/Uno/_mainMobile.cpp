// This file was generated based on '../../../../Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/backends/cplusplus/Uno/_mainMobile.cpp'.
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* CalendarPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* CommunionToSickPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* ComplinePage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* EveningPrayerPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* FamilyPrayerPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* Gloria_typeof();}
...
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* iphod_accessor_iphod_Versical_Speaker_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* iphod_accessor_iphod_Versical_Text_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* iphod_iphodVersical_Speaker_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* iphod_iphodVersical_Text_Property_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* MiddayPrayerPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* MorningPrayerPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* Psalm1_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* Psalm119_105_112_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* ReconciliationPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Shape_type;}} ::g::Fuse::Controls::Shape_type* Separator_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* StationsOfTheCrossPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* TimeOfDeathPage_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* TODO_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} ::g::Fuse::Controls::Control_type* ToTheSickPage_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace iphod{::g::Fuse::Controls::Control_type* Button_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace iphod{::g::Fuse::Controls::Control_type* Page_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} namespace iphod{::g::Fuse::Controls::TextControl_type* Rubric_typeof();}}
...
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace iphod{::g::Fuse::Controls::Control_type* Versical_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Control_type;}} namespace altReading{::g::Fuse::Controls::Control_type* Button_typeof();}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::iphod_accessor_iphod_Versical_Speaker_typeof,
        (uType*(*)())&::g::iphod_accessor_iphod_Versical_Text_typeof,
        ...
        (uType*(*)())&::g::iphod_iphodVersical_Speaker_Property_typeof,
        (uType*(*)())&::g::iphod_iphodVersical_Text_Property_typeof,
        ...
        (uType*(*)())&::g::Psalm119_105_112_typeof,
        ...
        (uType*(*)())&::g::iphod::Rubric_typeof,
        (uType*(*)())&::g::iphod::Text_typeof,
        (uType*(*)())&::g::iphod::Title_typeof,
        (uType*(*)())&::g::iphod::Versical_typeof,
