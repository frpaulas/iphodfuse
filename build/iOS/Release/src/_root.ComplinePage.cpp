...
// {
// static ComplinePage() :11
static void ComplinePage__cctor_5_fn(uType* __type)
{
    ComplinePage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb2"*/]);
}
...
static void ComplinePage_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("backTitle");
    ::STRINGS[3] = uString::Const("Pages/ComplinePage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Compline");
...
::g::Fuse::Controls::Control_type* ComplinePage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("ComplinePage", options);
...
// public ComplinePage(Fuse.Navigation.Router router) :15
...
// public ComplinePage New(Fuse.Navigation.Router router) :15
...
// public ComplinePage(Fuse.Navigation.Router router) [instance] :15
...
void ComplinePage::InitializeUX1()
{
    ...
    ::g::Fuse::Reactive::Data* temp = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"backTitle"*/]);
    ...
    temp_eb2 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/Compl...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb2)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb2);
    temp4->Value(::STRINGS[5/*"Compline"*/]);
...
// public ComplinePage New(Fuse.Navigation.Router router) [static] :15
