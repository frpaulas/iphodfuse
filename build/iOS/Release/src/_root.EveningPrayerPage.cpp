...
{
    EveningPrayerPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb3"*/]);
}
...
static void EveningPrayerPage_build(uType* type)
{
    ...
    type->SetFields(100,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::EveningPrayerPage, temp_eb3), 0,
...
::g::Fuse::Controls::Control_type* EveningPrayerPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("EveningPrayerPage", options);
...
void EveningPrayerPage::InitializeUX1()
{
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb3)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb3);
