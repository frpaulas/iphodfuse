...
// {
// static FamilyPrayerPage() :11
static void FamilyPrayerPage__cctor_5_fn(uType* __type)
{
    FamilyPrayerPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb4"*/]);
}

static void FamilyPrayerPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb4");
    ::STRINGS[2] = uString::Const("back");
    ::STRINGS[3] = uString::Const("Pages/FamilyPrayerPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Family Prayer");
    ...
    type->SetFields(100,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::FamilyPrayerPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::FamilyPrayerPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::FamilyPrayerPage, temp_eb4), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::FamilyPrayerPage::__g_static_nametable1_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Control_type* FamilyPrayerPage_typeof()
{
    ...
    options.ObjectSize = sizeof(FamilyPrayerPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("FamilyPrayerPage", options);
    type->fp_build_ = FamilyPrayerPage_build;
    type->fp_cctor_ = FamilyPrayerPage__cctor_5_fn;
...
// public FamilyPrayerPage(Fuse.Navigation.Router router) :15
...
// public FamilyPrayerPage New(Fuse.Navigation.Router router) :15
void FamilyPrayerPage__New6_fn(::g::Fuse::Navigation::Router* router1, FamilyPrayerPage** __retval)
{
    *__retval = FamilyPrayerPage::New6(router1);
}

uSStrong<uArray*> FamilyPrayerPage::__g_static_nametable1_;

// public FamilyPrayerPage(Fuse.Navigation.Router router) [instance] :15
void FamilyPrayerPage::ctor_9(::g::Fuse::Navigation::Router* router1)
{
    ctor_8();
    router = router1;
    InitializeUX1();
...
void FamilyPrayerPage::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, FamilyPrayerPage::__g_static_nametable1());
    ...
    temp_eb4 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/Famil...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb4)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb4);
    temp4->Value(::STRINGS[5/*"Family Prayer"*/]);
...
// public FamilyPrayerPage New(Fuse.Navigation.Router router) [static] :15
FamilyPrayerPage* FamilyPrayerPage::New6(::g::Fuse::Navigation::Router* router1)
{
    FamilyPrayerPage* obj1 = (FamilyPrayerPage*)uNew(FamilyPrayerPage_typeof());
    obj1->ctor_9(router1);
    return obj1;
}
// }
