...
::g::Fuse::Controls::Control_type* Gloria_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("Gloria", options);
...
void Gloria::InitializeUX()
{
    ...
    ::g::Indent* temp1 = ::g::Indent::New6();
    ::g::Indent* temp2 = ::g::Indent::New6();
    Margin(::g::Uno::Float4__New2(5.0f, 0.0f, 5.0f, 0.0f));
    temp->Value(::STRINGS[0/*"Glory to th...*/]);
    temp1->Value(::STRINGS[1/*"as it was i...*/]);
    temp2->Value(::STRINGS[2/*"world witho...*/]);
