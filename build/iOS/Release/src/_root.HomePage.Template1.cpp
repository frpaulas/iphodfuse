...
{
    HomePage__Template1::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"temp_eb5"*/]);
...
{
    ::STRINGS[0] = uString::Const("temp_eb5");
...
void HomePage__Template1__New1_fn(HomePage__Template1* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::EventBinding* temp_eb51 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp2, __this->__g_nametable1);
    __self1->HitTestMode(6);
    ::g::Fuse::Gestures::Clicked::AddHandler(__self1, uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, temp_eb51));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->__g_nametable1)->Objects()), ::TYPES[4/*Uno.Collections.ICollection<object>*/]), temp_eb51);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb51);
