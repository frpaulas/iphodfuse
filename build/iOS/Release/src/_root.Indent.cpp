// This file was generated based on '.uno/ux11/Indent.g.uno'.
...
// public partial sealed class Indent :2
// {
// static Indent() :4
static void Indent__cctor_6_fn(uType* __type)
{
}

static void Indent_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Indent_typeof()
{
    ...
    options.ObjectSize = sizeof(Indent);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Indent", options);
    type->fp_build_ = Indent_build;
    type->fp_ctor_ = (void*)Indent__New6_fn;
    type->fp_cctor_ = Indent__cctor_6_fn;
...
// public Indent() :8
void Indent__ctor_10_fn(Indent* __this)
{
    __this->ctor_10();
}

// private void InitializeUX() :12
void Indent__InitializeUX3_fn(Indent* __this)
{
    __this->InitializeUX3();
}

// public Indent New() :8
void Indent__New6_fn(Indent** __retval)
{
    *__retval = Indent::New6();
}

// public Indent() [instance] :8
void Indent::ctor_10()
{
    ctor_9();
    InitializeUX3();
...
void Indent::InitializeUX3()
{
    TextWrapping(1);
    Margin(::g::Uno::Float4__New2(20.0f, 0.0f, 5.0f, 0.0f));
    Font(::g::MainView::RegularFont());
}

// public Indent New() [static] :8
Indent* Indent::New6()
{
    Indent* obj1 = (Indent*)uNew(Indent_typeof());
    obj1->ctor_10();
    return obj1;
}
// }
