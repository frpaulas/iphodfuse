...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"calendarPage"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("calendarPage");
    type->SetFields(2,
...
{
    ::g::CalendarPage* __self1 = ::g::CalendarPage::New6(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"calendarPage"*/], false);
    __parent1 = parent;
