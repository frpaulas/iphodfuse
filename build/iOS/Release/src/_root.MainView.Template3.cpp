...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"middayPraye...*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("middayPrayerPage");
    type->SetFields(2,
...
{
    ::g::MiddayPrayerPage* __self1 = ::g::MiddayPrayerPage::New6(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template3::__selector0());
...
{
    ctor_(::STRINGS[0/*"middayPraye...*/], false);
    __parent1 = parent;
