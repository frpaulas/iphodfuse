...
{
    MainView__Template9::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"communionTo...*/]);
}

static void MainView__Template9_build(uType* type)
{
    ::STRINGS[0] = uString::Const("communionToSickPage");
    type->SetFields(2,
...
{
    ::g::CommunionToSickPage* __self1 = ::g::CommunionToSickPage::New6(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"communionTo...*/], false);
    __parent1 = parent;
