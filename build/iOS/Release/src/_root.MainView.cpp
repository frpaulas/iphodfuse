...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::RegularFont_, ::STRINGS[77/*"RegularFont"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::ItalicFont_, ::STRINGS[78/*"ItalicFont"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::BoldFont_, ::STRINGS[79/*"BoldFont"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::BoldItalicFont_, ::STRINGS[80/*"BoldItalicF...*/]);
...
static void MainView_build(uType* type)
{
    ...
    ::STRINGS[77] = uString::Const("RegularFont");
    ::STRINGS[78] = uString::Const("ItalicFont");
    ::STRINGS[79] = uString::Const("BoldFont");
    ::STRINGS[80] = uString::Const("BoldItalicFont");
...
void MainView::InitializeUX()
{
    ...
    ::g::Fuse::Android::StatusBarConfig* temp17 = ::g::Fuse::Android::StatusBarConfig::New2();
    ...
    temp16->Style(1);
    temp17->Color(::g::Uno::Float4__New2(0.007843138f, 0.1372549f, 0.1568628f, 1.0f));
    ...
    temp19->DefaultPath(::STRINGS[81/*"home"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), home);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), calendarPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), morningPrayerPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), middayPrayerPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), eveningPrayerPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), complinePage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), familyPrayerPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), reconciliationPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), toTheSickPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), communionToSickPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), timeOfDeathPage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), stationsOfTheCrossPage);
...
// public MainView New() [static] :373
