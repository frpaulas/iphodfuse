...
// {
// static MorningPrayerPage() :11
static void MorningPrayerPage__cctor_5_fn(uType* __type)
{
    MorningPrayerPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb7"*/]);
}
...
static void MorningPrayerPage_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("Pages/MorningPrayerPage.ux");
    ::STRINGS[4] = uString::Const("Back");
    ::STRINGS[5] = uString::Const("Morning Prayer");
    ...
    type->SetFields(100,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::MorningPrayerPage, temp_eb7), 0,
...
::g::Fuse::Controls::Control_type* MorningPrayerPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("MorningPrayerPage", options);
...
// public MorningPrayerPage(Fuse.Navigation.Router router) :15
...
// public MorningPrayerPage New(Fuse.Navigation.Router router) :15
...
// public MorningPrayerPage(Fuse.Navigation.Router router) [instance] :15
...
void MorningPrayerPage::InitializeUX1()
{
    ...
    temp_eb7 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ::g::iphod::Title* temp4 = ::g::iphod::Title::New4();
    temp1->LineNumber(3);
    temp1->FileName(::STRINGS[3/*"Pages/Morni...*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb7)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb7);
    temp4->Value(::STRINGS[5/*"Morning Pra...*/]);
...
// public MorningPrayerPage New(Fuse.Navigation.Router router) [static] :15
