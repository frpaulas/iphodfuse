// This file was generated based on '.uno/ux11/Psalm2.g.uno'.
...
// public partial sealed class Psalm2 :2
// {
// static Psalm2() :4
static void Psalm2__cctor_6_fn(uType* __type)
{
}

static void Psalm2_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Psalm2_typeof()
{
    ...
    options.ObjectSize = sizeof(Psalm2);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Psalm2", options);
    type->fp_build_ = Psalm2_build;
    type->fp_ctor_ = (void*)Psalm2__New6_fn;
    type->fp_cctor_ = Psalm2__cctor_6_fn;
...
// public Psalm2() :8
void Psalm2__ctor_10_fn(Psalm2* __this)
{
    __this->ctor_10();
}

// private void InitializeUX() :12
void Psalm2__InitializeUX3_fn(Psalm2* __this)
{
    __this->InitializeUX3();
}

// public Psalm2 New() :8
void Psalm2__New6_fn(Psalm2** __retval)
{
    *__retval = Psalm2::New6();
}

// public Psalm2() [instance] :8
void Psalm2::ctor_10()
{
    ctor_9();
    InitializeUX3();
...
// public Psalm2 New() [static] :8
Psalm2* Psalm2::New6()
{
    Psalm2* obj1 = (Psalm2*)uNew(Psalm2_typeof());
    obj1->ctor_10();
    return obj1;
}
// }
