...
{
    TimeOfDeathPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb10"*/]);
}

static void TimeOfDeathPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb10");
    ...
    type->SetFields(100,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::TimeOfDeathPage, temp_eb10), 0,
...
::g::Fuse::Controls::Control_type* TimeOfDeathPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("TimeOfDeathPage", options);
...
void TimeOfDeathPage::InitializeUX1()
{
    ...
    temp_eb10 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb10)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb10);
