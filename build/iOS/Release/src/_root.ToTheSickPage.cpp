...
{
    ToTheSickPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb11"*/]);
}
...
static void ToTheSickPage_build(uType* type)
{
    ...
    type->SetFields(100,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ToTheSickPage, temp_eb11), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::ToTheSickPage::__g_static_nametable1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Control_type* ToTheSickPage_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("ToTheSickPage", options);
...
void ToTheSickPage::InitializeUX1()
{
    ...
    temp_eb11 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp, __g_nametable1);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb11)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb11);
