// This file was generated based on '.uno/ux11/iphod.Bold.g.uno'.
...
// public partial sealed class Bold :4
// {
// static Bold() :6
static void Bold__cctor_5_fn(uType* __type)
{
}

static void Bold_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Bold_typeof()
{
    ...
    options.ObjectSize = sizeof(Bold);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("iphod.Bold", options);
    type->fp_build_ = Bold_build;
    type->fp_ctor_ = (void*)Bold__New5_fn;
    type->fp_cctor_ = Bold__cctor_5_fn;
...
// public Bold() :10
void Bold__ctor_9_fn(Bold* __this)
{
    __this->ctor_9();
}

// private void InitializeUX() :14
void Bold__InitializeUX2_fn(Bold* __this)
{
    __this->InitializeUX2();
}

// public Bold New() :10
void Bold__New5_fn(Bold** __retval)
{
    *__retval = Bold::New5();
}

// public Bold() [instance] :10
void Bold::ctor_9()
{
    ctor_8();
    InitializeUX2();
...
void Bold::InitializeUX2()
{
    Font(::g::MainView::BoldFont());
}

// public Bold New() [static] :10
Bold* Bold::New5()
{
    Bold* obj1 = (Bold*)uNew(Bold_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
