// This file was generated based on '.uno/ux11/iphod.Italic.g.uno'.
...
// public partial class Italic :4
// {
// static Italic() :6
static void Italic__cctor_5_fn(uType* __type)
{
}

static void Italic_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Italic_typeof()
{
    ...
    options.ObjectSize = sizeof(Italic);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("iphod.Italic", options);
    type->fp_build_ = Italic_build;
    type->fp_ctor_ = (void*)Italic__New5_fn;
    type->fp_cctor_ = Italic__cctor_5_fn;
...
// public Italic() :10
void Italic__ctor_9_fn(Italic* __this)
{
    __this->ctor_9();
}

// private void InitializeUX() :14
void Italic__InitializeUX2_fn(Italic* __this)
{
    __this->InitializeUX2();
}

// public Italic New() :10
void Italic__New5_fn(Italic** __retval)
{
    *__retval = Italic::New5();
}

// public Italic() [instance] :10
void Italic::ctor_9()
{
    ctor_8();
    InitializeUX2();
...
void Italic::InitializeUX2()
{
    Font(::g::MainView::ItalicFont());
}

// public Italic New() [static] :10
Italic* Italic::New5()
{
    Italic* obj1 = (Italic*)uNew(Italic_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
